...
namespace ERP_version1.Controllers
{
    ...
    public class LeaveTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LeaveTypeId,LeaveTypeName,DefaultDays,IsActive,CreatedAt")] LeaveType leaveType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("LeaveTypeId,LeaveTypeName,DefaultDays,IsActive,CreatedAt")] LeaveType leaveType)
        {
